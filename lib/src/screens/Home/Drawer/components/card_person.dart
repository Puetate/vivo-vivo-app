...
class CardPerson extends StatelessWidget {
  ...
  final Function? onDeleteFamilyMember;

  const CardPerson({super.key, required this.user, this.onDeleteFamilyMember});
            ...
            children: [
              Row(
                ...
                children: [
                  ...
                  if (onDeleteFamilyMember != null)
                    IconButton.outlined(
                        onPressed: () => onDeleteFamilyMember!(),
